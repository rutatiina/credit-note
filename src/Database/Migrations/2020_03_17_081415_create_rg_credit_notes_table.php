...
class CreateRgCreditNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_credit_notes', function (Blueprint $table) {
            ...
            $table->string('document_name', 50)->default('Credit Note');
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_credit_notes');
    }
}
