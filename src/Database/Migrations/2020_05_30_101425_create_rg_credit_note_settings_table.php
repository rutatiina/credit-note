...
class CreateRgCreditNoteSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_credit_note_settings', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_credit_note_settings');
    }
}
