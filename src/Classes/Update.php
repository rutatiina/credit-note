...
use Rutatiina\CreditNote\Traits\Inventory as TxnTraitsInventory;
use Rutatiina\CreditNote\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = CreditNote::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
